...
class BERTAnimation(MovingCameraScene):
    def construct(self):
        ...
        # HorizontalBERT HorizontalBERT HorizontalBERT
        ...
        # temp = VGroup(box_dic["box_5"], text_dic["text_5"], colour_dic["colour_5"])
        # self.play(temp.animate.move_to((box_dic[f"box_{1}"].get_center())))
